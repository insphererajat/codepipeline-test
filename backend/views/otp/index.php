            ...
            <div class="adm-c-tableGrid__container">
                    ...
                    $gridView = GridView::begin([
                                ...
                                'columns' => [
                                    ...
                                    return ($model->otp_type == 1) ? 'Email' : 'Mobile';
                                },
                                    ],
                                    [
                                        ...
                                        'sortLinkOptions' => ['class' => 'sort'],
                                        'value' => function ($model) {
                                    return ($model->is_verified == 1) ? "<span class='badge badge-success'>Verified</span>": "<span class='badge badge-danger'>Not Verified</span>";
                                },
                                    ],
                                    [
