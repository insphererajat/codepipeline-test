<?php
$permissions = \common\models\Permission::getCategoriesPermissionArr();
        ...
        <div class="adm-c-sectionHeader design3">
            <div class="adm-c-sectionHeader__container p-0">
                <div class="adm-c-sectionHeader__label">
                    <div class="adm-c-sectionHeader__label__title fs16__medium"> Categories / Category Criteria </div>
                </div>
            </div>
        </div>
