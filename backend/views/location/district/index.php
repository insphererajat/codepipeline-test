...
$this->params['breadcrumb'][] = ['label' => 'District',  'class' => 'active'];
$this->params['breadcrumbMenu'][] = ['label' => 'Search', 'icon' => 'fa fa-search', 'url' => "javascript:;", 'class' => 'js-searchBreadcrumb'];
$this->params['breadcrumbMenu'][] = ['label' => 'Create', 'icon' => 'fa fa-plus', 'url' => Url::toRoute(['/location/district/create'])];

$this->registerJs('LocationController.district();');
?>
    ...
    <section class="adm-c-tableGrid  adm-c-tableGrid-xs design2">
        <div class="adm-c-tableGrid__wrapper">
            <div class="adm-c-tableGrid__wrapper__head">
                <?= $this->render('../partials/_search-form.php', ['model' => $searchModel, 'showState' => true, 'url' => Url::toRoute(['location/district/index'])]) ?>
            </div>
                        ...
                        'columns' => [
                            [
                                ...
                                'value'=>function($model){
                                    ...
                                    return !empty($model->state_code)  ? $model->stateCode->name: '';
                                 }
                            ],
                            [
                                'attribute' => 'code',
                                        ...
                                        [
                                                ...
                                                'buttons' => [
                                                    'update' => function ($url, $model, $key) {
                                                        return Html::a('<i class="fa fa-edit"></i>', Url::toRoute(['location/district/update', 'guid' => $model->guid]), [
                                                                    'title' => Yii::t('yii', \Yii::t('yii', 'update')),
                                                        ...
                                                        return Html::a('<i class="far fa-trash-alt"></i>', 'javascript:;', [
                                                                    ...
                                                                    'data-url' => Url::toRoute(['location/district/delete', 'guid' => $model->guid]),
