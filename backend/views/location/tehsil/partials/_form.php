...
if (!empty($model->state_code)) {
    $districtDropDownList = common\models\location\MstDistrict::getDistrictDropdown([
...
<div class="adm-basicBlock white adm-u-pad20_25">
    ...
    <div class="adm-c-form adm-c-form-xs adm-u-fieldRadius8 adm-u-fieldShadow adm-u-fieldBorderClr2 col2">
        <?=
                $form->field($model, 'state_code', [
                    'options' => ['class' => 'form-grider cop-form design1 stateCode'],
        ...
        <?=
                ...
                ->dropDownList($districtDropDownList, ['class' => 'chzn-select districtCode', 'prompt' => 'Select District']
    ...
    <div class="adm-u-flexed adm-u-justify-start cmt-20">
        <?= Html::submitButton($model->code <= 0 ? 'Create' : 'Update', ['class' => 'btn btn-primary adm-u-pad10_30 theme-button mb-3', 'name' => 'tehsil-button']) ?>
        <a href="<?= Url::toRoute(['/location/tehsil/index']) ?>" class="btn  adm-u-pad10_30 ml-3 mb-3 btn-secondary ">Cancel</a>
    </div>
    <?php ActiveForm::end(); ?>
</div>