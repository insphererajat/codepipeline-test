...
$this->params['breadcrumb'][] = ['label' => 'State',  'class' => 'active'];
$this->params['breadcrumbMenu'][] = ['label' => 'Search', 'icon' => 'fa fa-search', 'url' => "javascript:;", 'class' => 'js-searchBreadcrumb'];
$this->params['breadcrumbMenu'][] = ['label' => 'Create', 'icon' => 'fa fa-plus', 'url' => Url::toRoute(['/location/state/create'])];
    ...
    <section class="adm-c-tableGrid  adm-c-tableGrid-xs design2">
        <div class="adm-c-tableGrid__wrapper">
            <div class="adm-c-tableGrid__wrapper__head">
                <?= $this->render('../partials/_search-form.php', ['model' => $searchModel, 'url' => Url::toRoute(['location/state/index'])]) ?>
            </div>
                                        ...
                                        [
                                                ...
                                                'buttons' => [
                                                    'update' => function ($url, $model, $key) {
                                                        return Html::a('<i class="fa fa-edit"></i>', Url::toRoute(['location/state/update', 'guid' => $model->guid]), [
                                                        ...
                                                        return Html::a('<i class="far fa-trash-alt"></i>', 'javascript:;', [
                                                                    ...
                                                                    'data-url' => Url::toRoute(['location/state/delete', 'guid' => $model->guid]),
