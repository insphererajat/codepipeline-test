            ...
            <?php
                ...
                <tr class="levelone">
                    ...
                    <td>
                        <table class="searchtable table table-bordered table-striped">
                            <tr>
                                <td><?= $record['totalPending'] + $record['totalSubmitted']; ?></td>
                            </tr>
                        </table>
                    ...
                    <?php foreach ($record['classified'] as $classifiedId => $classified): ?>
                        <tr class="leveltwo"  style="display:none;">
                            ...
                            <td>
                                <table class="searchtable table table-bordered table-striped">
                                    <tr>
                                        <td><?= $classified['totalPending'] + $classified['totalSubmitted']; ?></td>
                                    </tr>
                                </table>
                            </td>
                            <td class="js-showColoumns" style="display:none">
                            ...
                            <td class="js-showColoumns" style="display:none">
                                <table class="searchtable table table-bordered table-striped">
                                    <tr>
                                        <td><?= $classified['totalSubmitted']; ?></td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <?php foreach ($classified['post'] as $postId => $post): ?>
                            <tr class="levelthree js-sectionWise<?= $dataNum; ?>" data-sec="<?= $post['totalPending']; ?>" style="display:none">
                                <td>
                                    <a class="js-showEnrollWise" data-sec="<?= $post['totalPending']; ?>" href="javascript:;">
                                ...
                                <td>
                                    <table class="searchtable table table-bordered table-striped">
                                        <tr>
                                            <td><?= $post['totalPending'] + $post['totalSubmitted']; ?></td>
                                        </tr>
                                    </table>
                                </td>        
