...
$examCentreDetail = ExamCentreDetail::findByKeys([
    'resultFormat' => ModelCache::RETURN_TYPE_OBJECT,
    'examCentreId' => $params['ApplicantSearch']['exam_centre_id']
]);
                    ...
                    <tr>
                        <td class="table-item1">
                            <table cellpadding="0" cellspacing="0" class="headercentertext__v3 w100">
                                <tr>
                                    <td class="topline"><u>HP STATE LEGAL SERVICES AUTHORITY SHIMLA-171001</u></td>
                                </tr>
                                <tr>
                                    <td class="topline"><u>ATTENDANCE SHEET</u></td>
                                </tr>
                                <tr>
                                    <td class="middleline">(<u><strong>Attendance to be obtained by the Invigilation staff</strong></u>)</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="table-item2">:
                                                <strong class="text-red">STENO-TYPIST (ON CONTRACT BASIS)</strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table cellpadding="0" cellspacing="0" class="datawithlable datawithlable__v4">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="table-item2">:
                                                <strong class="text-red">SHORTHAND TEST (IN ENGLISH) AND TYPE TEST IN BOTH LANGUAGES (I.E. HINDI AND ENGLISH)</strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <table cellpadding="0" cellspacing="0" class="dataview dataview__v15">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table-item5">Signature of <br />Candidate’s <br />(During test)</th>
                                        <th class="table-item6">Remarks, if any</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    if(isset($records) && !empty($records)):
                                        ...
                                        $subcategory = MstListType::getListTypeDropdownByParentId(MstListType::DISABILITY);
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-item2 left-text">
                                            ...
                                            Category:
                                            <?= isset($categories[$record['social_category_id']]) ? $categories[$record['social_category_id']] : '' ?> <br />
                                            Sub-Category:
                                            <?= isset($subcategory[$record['disability_id']]) ? $subcategory[$record['disability_id']] : '' ?> <br />
                                        </td>
                            ...
                            <td class="table-item2">
                                <table cellpadding="0" cellspacing="0" class="datawithlable datawithlable__v13">
                                    <tbody>
                                        <tr>
                                            <td class="table-item1">
                                                <div class="label">Signature of Centre/Deputy Supervisor</div>
