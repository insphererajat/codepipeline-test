...
$this->params['breadcrumb'][] = ['label' => 'Subjects',  'class' => 'active'];
$this->params['breadcrumbMenu'][] = ['label' => 'Search', 'icon' => 'fa fa-search', 'url' => "javascript:;", 'class' => 'js-searchBreadcrumb'];
$this->params['breadcrumbMenu'][] = ['label' => 'Create', 'icon' => 'fa fa-plus', 'url' => Url::toRoute(['/subject/create'])];
?>
                            ...
                            [
                                ...
                                'contentOptions' => function ($model) {
                                    return [
                                        ...
                                        'data-url' => Url::toRoute(['subject/status', 'guid' => $model->guid])
                                    ];
                                },
                                'value' => function ($data) {
                            ...
                            [
                                ...
                                'buttons' => [
                                    'update' => function ($url, $model, $key) {
                                        return Html::a('<i class="fa fa-edit"></i>', Url::toRoute(['subject/update', 'guid' => $model->guid]), [
                                    ...
                                    'delete' => function ($url, $model, $key) {
                                        return Html::a('<i class="far fa-trash-alt"></i>', 'javascript:;', [
                                            ...
                                            'data-url' => Url::toRoute(['subject/delete', 'guid' => $model->guid]),
