...
$showSearchCls = (isset($searchParams['MstSubjectSearch']) && !empty($searchParams['MstSubjectSearch'])) ? "" : "hide";
?>
...
<div class="filters-wrapper adm-u-pad7_10 <?= $showSearchCls ?>">
    ...
    $form = ActiveForm::begin([
                ...
                'method' => 'GET',
                'action' => Url::toRoute(['/subject/index']),
                'options' => [
    ...
    <div class="filters-wrapper__action">
        <div class="adm-c-button cml-10">
            ...
            <a href="<?= Url::toRoute(['/subject/index']) ?>"  class = 'btn btn-dark  adm-u-pad15_22 mb-1'>Reset</a>
        </div>
    </div>
    <?php ActiveForm::end(); ?>
</div>