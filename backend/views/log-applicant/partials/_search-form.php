...
$showSearchCls = (isset($searchParams['LogApplicantSearch']) && !empty($searchParams['LogApplicantSearch'])) ? "" : "hide";
?>
<div class="filters-wrapper adm-u-pad7_10 <?= $showSearchCls ?>">
    <?php
    $form = ActiveForm::begin([
                'id' => 'LogApplicantSearchForm',
                'method' => 'GET',
                'options' => [
    ...
    <div class="adm-c-form adm-c-form-xs adm-u-fieldRadius8 adm-u-fieldShadow adm-u-fieldBorderClr2 col4">
        ...
        <?=
                ...
                ->dropDownList([LogApplicant::TYPE_EMAIL => 'Email', LogApplicant::TYPE_MOBILE => 'Moble'], ['class' => 'chzn-select', 'prompt' => 'Select Type']
                )->label(FALSE)
        ?>
        <?=
                ...
                ->dropDownList([LogApplicant::DESKTOP_DEVICE => 'Desktop', LogApplicant::MOBILE_DEVICE => 'Moble', LogApplicant::TAB_DEVICE => 'Tablet'], ['class' => 'chzn-select', 'prompt' => 'Select Device Type']
                )->label(FALSE)
        ?>
    </div>
