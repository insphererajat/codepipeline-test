                    ...
                    <div class="login__wrap__form">
                        <div class="login__wrap__container">
                            <div class="c-form u-fieldRadius8 u-fieldShadow u-fieldBorderClr2">
                                ...
                                <?php
                                $form = ActiveForm::begin(['id' => 'log-applicant-form',
                                            'options' => [
                         ...
                         <span class='far fa-question-circle icon' data-toggle='tooltip' title='Mother`s'></span>
                                ...
                                <div class="form-grider design1">
                                    ...
                                    $form->field($model, 'captcha', [
                                        'labelOptions' => ['class' => 'is__form__label fullwidth'],
                                        'inputOptions' => [
                                            'maxlength' => true,
                                            'autofocus' => true,
                                            'autocomplete' => 'off',
                                        ...
                                        'template' => "<div class='head-wrapper'>
                        <div class='head-wrapper__title label-required'>
                        <div class='head-wrapper__title-label fs14__medium'>Captcha</div>
                        </div></div><div class='row'><div class='col-md-4'>{image}</div> <div class='col-md-8'>{input}</div> </div>",
                                        'options' => [
                                            'class' => 'cop-form--container-field u-fieldHeight48 alpha-numeric-with-special disable-copy-paste cmb-5 captcha-textbox'
                                        ],
                                        'imageOptions' => [
                                            'id' => 'captcha-image'
                                        ]
