<?php
namespace components\integration\payment\bob;
...
class ipayTransactionPipe {
	 ...
	 * ********************************************************************************************
	 */
	public function performHostedTransaction($request, $webAddress) {
	 ...
	 * ********************************************************************************************
	 */
	public function performTranPortalVbyVTransaction(String $request, String $webAddress) {
	...
	public function performTranPortalIVRVbyVTransaction($request, $webAddress) {
	...
	public function performTranPortalVbyVPAReqTransactionIVR($request, $webAddress) {
	...
	// End for IVR 3D
	public function performTranPortalPreAuthTransaction($request, $webAddress) {
	...
	public function performTranPortalVbyVEnrolledTransaction($request, $webAddress) {
...
public function parseRequestResponse($response){
