 ...
 */
class ApplicantCriteriaDetail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['guid', 'post_id', 'qualification_id'], 'required'],
            [['post_id', 'option_seq', 'qualification_id', 'subject_id', 'university_id', 'eligible_year', 'additional_qualification_id', 'additional_subject_id', 'additional_university_id', 'is_active', 'is_deleted', 'created_by', 'created_on', 'modified_by', 'modified_on'], 'integer'],
            [['guid'], 'string', 'max' => 36],
            [['guid'], 'unique'],
