...
/**
 * This is the model class for table "mst_employment_office".
 *
 * @property int $id
 ...
 */
class MstEmploymentOffice extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Applicant::className(), ['employment_registration_office_id' => 'id']);
    }
