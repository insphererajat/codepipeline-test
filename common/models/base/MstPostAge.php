...
/**
 * This is the model class for table "mst_post_age".
 *
 * @property int $id
 ...
 */
class MstPostAge extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['classified_id', 'min_age', 'max_age'], 'required'],
            [['classified_id', 'post_id', 'category_id', 'sub_category_id', 'min_age', 'max_age', 'is_active', 'is_deleted', 'created_on', 'created_by', 'modified_on', 'modified_by'], 'integer'],
            [['guid'], 'string', 'max' => 36],
            [['guid'], 'unique'],
