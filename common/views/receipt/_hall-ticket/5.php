                    ...
                    <tr>
                        <td class="table-item1">
                            <table cellpadding="0" cellspacing="0" class="headercentertext__v3 w100">
                                ...
                                <tr>
                                    <td class="middleline red">SCREENING TEST FOR THE POST OF JUNIOR OFFICE ASSISTANT (IT) ON<br/>CONTRACT BASIS</td>
                                </tr>
                                <tr>
                ...
                <table cellpadding="0" cellspacing="0" class="">
                    <tr>
                        <td class="txt-justify">
                            <div class="normaltext3"><strong>You are required to report at the venue of <span class="red">Examination Centre</span> at least an hour before the scheduled timings of screening test a/w Admit Card. Your candidature shall only be allowed provisionally subject to production of requisite documents. You are also required to go through the <span class="red">COVID-19 INSTRUCTION /GENERAL INSTRUCTIONS</span> etc. at the Website of HP State Legal Services Authority. The candidate shall have to bring their own stationery articles viz. Pencil, Blue Ball point pen, card board etc. for being used during the test/exams.</strong>
                            </div>
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td class="fullwidth">
                <table cellpadding="0" cellspacing="0" class="bulletpoint bulletpoint__v1">
                    ...
                    <tr>
                        <td colspan="2" class="bulletpoint__subhead txt-justify red">Screening Test for the post of Junior Office Assistant (IT) on Contract basis scheduled to be held on 30th October, 2022 (Sunday) at 10:00 A.M. onwards.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="bullet">2.</td>
                        <td class="content txt-justify">The candidate is required to paste a passport size latest attested photograph in the space provided on the Admit Card. No candidate will be allowed to appear in the examination without Admit Card and latest passport size attested photograph duly affixed on it.</td>
                    </tr>

                    <tr>
                        <td class="bullet">3.</td>
                        <td class="content txt-justify">If ineligibility is found at any stage before or after the screening test or if the conditions prescribed in the Rules & instructions given in the Advt. notice for the test are not complied with or any additional information/ documents called for at any stage are not furnished within the time specified therein, his/her candidature will be liable to be cancelled.</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="content txt-justify">The HP State Legal Services Authority will not supply any stationery articles.</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="content txt-justify">Re-checking/ re-evaluation, for the OMR Sheets will not be allowed in any case.</td>
                    </tr>
